...
public class RMCListener extends AbstractSentenceListener<RMCSentence> {
    ...
    public void sentenceRead(RMCSentence rmc) {
        ...
        BoatInformarion p = new BoatInformarion(PeregrinaNMEAUtils.defaultPrecision(pos.getLatitude()), PeregrinaNMEAUtils.defaultPrecision(pos.getLongitude()), jodaTimeParser.parseDateTime(rmc.getDate().toISO8601(rmc.getTime())).toDate());
