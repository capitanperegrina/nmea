...
public enum SimpleSevenSegmentsAlphabet {
    BLANK(new char[]{' '}, null),
    ...
    public static final Map<Character, SimpleSevenSegmentsAlphabet> MAP;

    static {
        MAP = new HashMap<Character, SimpleSevenSegmentsAlphabet>(36);
        for (final SimpleSevenSegmentsAlphabet alfabet : SimpleSevenSegmentsAlphabet.values()) {
    ...
    SimpleSevenSegmentsAlphabet(final char[] characters, final Integer... segments) {
