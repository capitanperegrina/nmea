...
public class SixteenSegments {
    ...
    static {
        ...
        segmentPolygons.get(SixteenSegment.SEGMENT_13).add( new SegmentComponent(PolygonType.TRIANGLE, Arrays.asList(new Pair[] {new Pair<>(4,40), new Pair<>(5,42), new Pair<>(12,25)})));
        ...
        segmentPolygons.get(SixteenSegment.SEGMENT_DOT).add( new SegmentComponent(PolygonType.CIRCLE, Arrays.asList(new Pair[] {new Pair<>(30,42), new Pair<>(1,null)})));
        ...
        segmentPolygons.get(SixteenSegment.SEGMENT_COMMA).add( new SegmentComponent(PolygonType.TRIANGLE, Arrays.asList(new Pair[] {new Pair<>(30,43), new Pair<>(31,43), new Pair<>(30,45)})));
        segmentPolygons.get(SixteenSegment.SEGMENT_COMMA).add( new SegmentComponent(PolygonType.TRIANGLE, Arrays.asList(new Pair[] {new Pair<>(30,43), new Pair<>(29,45), new Pair<>(30,45)})));
    }
